...
ГРАУНДИНҐ (критично): у пункті «✅ На основі робочих креативів Aveola» посилайся ВИКЛЮЧНО на креативи з наданого нижче списку наших успішних — лише їхні реальні назви/crid і реальний Creo Result. НЕ вигадуй назв, crid чи результатів, яких немає у списку. Якщо доречного прикладу немає — так і напиши («прямого аналога серед наданих немає»).

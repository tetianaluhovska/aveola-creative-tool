...
- Дані: 🎯 З референсу конкурента — <що саме взято: який хук/візуал/структура/angle>; ✅ З наших успішних — <що додано: конкретний патерн/елемент і звідки, з посиланням на Creo Result (Okay/Good/Super) або crid/назву нашого креатива>
